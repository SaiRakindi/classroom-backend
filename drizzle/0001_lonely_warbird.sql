...
--> statement-breakpoint
ALTER TABLE "departments" RENAME COLUMN "createdAt" TO "created_at";--> statement-breakpoint
...
ALTER TABLE "departments" DROP COLUMN "updatedAt";--> statement-breakpoint
ALTER TABLE "subjects" DROP COLUMN "createdAt";--> statement-breakpoint
ALTER TABLE "subjects" DROP COLUMN "updatedAt";--> statement-breakpoint
